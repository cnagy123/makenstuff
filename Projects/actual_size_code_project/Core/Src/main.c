...
int main(void)
{
  ...
  /* definition and creation of switchIPTask */
  osThreadDef(switchIPTask, SwitchIPTask, osPriorityIdle, 0, 128);
  switchIPTaskHandle = osThreadCreate(osThread(switchIPTask), NULL);
...
/* USER CODE BEGIN Header_SwitchIPTask */
/**
* @brief Function implementing the switchIPTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_SwitchIPTask */
void SwitchIPTask(void const * argument)
{
  /* USER CODE BEGIN SwitchIPTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END SwitchIPTask */
}
